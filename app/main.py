...
# We explicitly allow the common Vite development URLs.
#
# This prevents browser-side "Failed to fetch" errors when
# the React frontend runs on localhost or 127.0.0.1.
...
# ----------------------------------------------------------
# Include origins configured in application settings
# ----------------------------------------------------------
