        ...
        return (
          ...
          >
            <div className="settings-profile">
              ...
              <div>
                <h3>{localStorage.getItem('user_name') || 'User'}</h3>
  ...
  const themeOptions = [
    {
      id: 'ledger' as const,
      name: 'Ledger',
      description: 'Calm fintech navy + green',
      accentLight: '#3D6E5C',
      accentDark: '#4E8E77',
      surfaceLight: '#F4F5F2',
      surfaceDark: '#0F1A2B',
    },
    {
      id: 'gold' as const,
      name: 'Gold',
      description: 'Premium black/white + gold',
      accentLight: '#B8892B',
      accentDark: '#D4AF37',
      surfaceLight: '#FAFAF8',
      surfaceDark: '#0B0B0C',
    },
    {
      id: 'slate' as const,
      name: 'Slate',
      description: 'Neutral admin dashboard',
      accentLight: '#3B5DE0',
      accentDark: '#6B8AF0',
      surfaceLight: '#F1F2F4',
      surfaceDark: '#111418',
          ...
          {themeOptions.map((option) => (
            <button
              ...
              style={{
                ...
                border: theme === option.id ? '2px solid var(--accent)' : '2px solid var(--border)',
            ...
            >
              <div style={{
                ...
                <div style={{
                  ...
                  height: '24px',
                  borderRadius: '50%',
                  background: mode === 'dark' ? option.accentDark : option.accentLight,
                ...
                <div style={{
                  ...
                  height: '24px',
                  borderRadius: '50%',
                  background: mode === 'dark' ? option.surfaceDark : option.surfaceLight,
                  border: '2px solid var(--border)',
                }}/>
              </div>
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              borderRadius: 'var(--radius)',
              border: mode === 'light' ? '2px solid var(--accent)' : '1px solid var(--border)',
              backgroundColor: mode === 'light' ? 'var(--accent)' : 'var(--surface-1)',
          ...
          <button
            ...
            style={{
              ...
              padding: '0.75rem 1rem',
              borderRadius: 'var(--radius)',
              border: mode === 'dark' ? '2px solid var(--accent)' : '1px solid var(--border)',
              backgroundColor: mode === 'dark' ? 'var(--accent)' : 'var(--surface-1)',
