        ...
        <div className="content">
          {loading ? (
            <div
              ...
              style={{ minHeight: "70vh", display: "flex", flexDirection: "column", justifyContent: "center", gap: "20px" }}
            >
              <div style={{ display: "flex", justifyContent: "center", gap: "8px" }}>
                ...
                <Loader2
                  size={28}
                  className="spin"
                  style={{ color: "#c4a030", animation: "spin 1.2s linear infinite", animationDirection: "reverse" }}
                />
              </div>

              <strong style={{ fontSize: "16px" }}>
                Loading BillSphere Dashboard...
              </strong>

              <span style={{ fontSize: "12px", color: "#8b857b" }}>
                Fetching subscriptions, customers, invoices, plans and payments...
              </span>
